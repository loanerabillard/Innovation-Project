      ...
      >
        ...
        <div data-thq="thq-navbar-nav" class="home-desktop-menu">
          <nav class="home-links">
            ...
            <span class="home-nav32 bodySmall">Live Betting</span>
            <span class="home-nav42 bodySmall">Promotions</span>
            <span class="home-nav52 bodySmall">Support</span>
          </nav>
    ...
    <div class="home-hero">
      <div class="heroContainer home-hero1">
        <div class="home-container01">
          <h1 class="home-hero-heading heading1">Welcome to Sportifs Bet</h1>
        ...
        <div class="home-features1">
          ...
          <div class="home-container03">
            <feature-card
              ...
              subHeading="Place bets on ongoing matches in real-time"
            ></feature-card>
            <feature-card
              heading="Multiple Sports"
              subHeading="Bet on a wide range of sports including football, basketball, tennis, and more"
            ></feature-card>
            <feature-card
              heading="Secure Transactions"
              subHeading="Enjoy peace of mind with secure payment options for deposits and withdrawals"
            ></feature-card>
            <feature-card
              heading="Mobile Compatibility"
              subHeading="Bet on the go with our mobile-friendly platform"
            ></feature-card>
          </div>
        </div>
      </div>
    ...
    <div class="home-footer">
      <footer class="footerContainer home-footer1">
        <div class="home-container31">
          ...
          <nav class="home-nav1">
            <span class="bodySmall">Home</span>
            <span class="home-nav222 bodySmall">Sports Betting</span>
            <span class="home-nav322 bodySmall">Live Betting</span>
            <span class="home-nav422 bodySmall">Promotions</span>
            <span class="home-nav522 bodySmall">Support</span>
          </nav>
        </div>
